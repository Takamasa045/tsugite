...
export function buildReleaseReadinessReport(input: ReleaseReadinessEvidenceStore): ReleaseReadinessReport {
  const supportedPre1Version = input.package_version === "0.9.0" || input.package_version === "0.10.0" || input.package_version === "0.11.0" || input.package_version === "0.12.0" || input.package_version === "0.13.0" || input.package_version === "0.14.0";
