...
<body>
  ...
  <main id="main" data-design="joinery-review" data-material="hinoki-yakisugi">
    <header class="hero">
      <nav class="review-nav" aria-label="レビュー内ナビゲーション">
        ...
        <div>${document.background ? `<a href="#background-title">背景</a>` : ""}<a href="#storyboard-title">絵コンテ</a><a href="#characters-title">キャラクター</a><a href="#details-title">カット詳細</a><a href="#decision-title">承認判断</a></div>
      </nav>
