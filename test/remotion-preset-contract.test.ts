...
describe("remotion preset contract", () => {
  it("keeps the data-only capability declaration aligned with the executable registry", async () => {
    ...
    expect(source).toContain(
      "presets: [article-dialogue-16x9, street-dialogue-16x9, tsugite-summer-camp-generated-16x9, miraichi-lastcall-9x16, orbital-showreel-16x9, matrix-code-form-9x16, nature-vibe-visualizer-9x16]"
    );
  });
