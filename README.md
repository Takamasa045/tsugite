...
Source version **0.17.0**. Public Desktop installers have ended; everyday use is this GitHub repository plus Codex, Claude Code, or another local coding agent, with a loopback browser launcher for inspection. See the [changelog](CHANGELOG.md).
...
| Tesseract | Optional local backend using official CLI 0.2.0. Native document/action authoring, six canvases, 24/30/60 fps, 720p/1080p/4K MP4, preview/filmstrip, and optional macOS ProRes/alpha-solo outputs. Real 0.2.0 rendering remains unverified; Fast Edit is unsupported | [Tesseract](docs/tesseract.md) |
