...
Claude Code固有のpermissionとhookは `CLAUDE.md` および `.claude/settings.json` を併用する。既存の `/tsugite-plan`、`/tsugite-verify`、`/tsugite-finalize`、`/shitate-import` も目的別の短縮入口として利用できる。
